...
def traintestf1score(model,x_train,x_test, y_train,y_test):
...
pvalues = sys.argv[3]
ddropout = [float(sys.argv[4])]
optimizer = [sys.argv[5]]
batchsize = [int(sys.argv[6])]
epochsnumber = [int(sys.argv[7])]
